package com.karasluo.libcommon.widget;
...
//            Log.i(TAG,"isShowing="+dialog.isShowing());
    ...
    private  class ProgressDialogWithMsg extends AppDialog{
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.common_dialog_progress_with_msg);
    ...
    private  class ProgressDialogWithPercent extends AppDialog{
        ...
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.common_dialog_progress_with_percent);
            //设置标题
